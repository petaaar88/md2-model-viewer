...
INSTALLATION
   ...
   Quake2\baseq2\players\ folder.  If you have the original
   Sideswipe player model, you can do one of two things:  
   1. Overwrite the old model (tris.md2, etc), which will 
   leave you with some skins from the original that won't be 
   used, and can be deleted, or 2.If you want to keep the old 
   model, you'll have to move it to another directory.  If you 
   put it in a directory with a different name, note the the 
   weapon model won't find it's skin.  Choices, choices...
